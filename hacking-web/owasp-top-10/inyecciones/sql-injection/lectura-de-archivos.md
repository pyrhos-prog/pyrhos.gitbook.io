...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto. La entrada incluye root@localhost, 3 y 4](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/Gz1nxv4XZCZr66Oll9gx/db_user.jpg)
...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto. La entrada incluye root@localhost, 3 y 4](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/aLyBAVWVAC5XnaaaedZq/root_privs.jpg)
...
![Interfaz de búsqueda con un cuadro de texto que contiene 'cn' UNION SELECT 1, grant' y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto. Las entradas incluyen 'root'@'localhost' con valores de Port City como SELECT, INSERT, UPDATE y Port Volume 4](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/r57fWCreQWlDg5aJMziQ/root_privs_2.jpg)
...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto. Las entradas incluyen información del usuario como root:x:0:0:root:/root:/bin/bash y daemon:x:1:1:daemon:/usr/sbin:/usr/sbin/nologin](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/oKgkJ2czDeBEln85u7yO/load_file_sqli.png)
...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto.](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/xaydsbKKFSKPCpTtuAEY/load_file_search.png)

La fuente HTML / PHP mostrada (fragmento):

![Fragmento de código PHP para consultar una base de datos. Comprueba si 'port\_code' está configurado, construye una consulta SQL para seleccionar entre 'puertos' donde el código coincide, ejecuta la consulta y obtiene resultados](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/jiWRA1Zaytw9CFAJnJBK/load_file_source.png)
