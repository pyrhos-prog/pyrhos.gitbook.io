...
![](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/v056XoTNog4DSbKIlMMD/ports_cn.png)
...
![](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/8BmHBf0ItUuRSonocqzc/ports_quote.png)
...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto. Un mensaje de error indica: Columna desconocida '5' en la cláusula de orden](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/zcbixUMY32hPERNE0Suq/order_by_5.jpg)
...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto. Las entradas incluyen 2, 3 y 4](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/iJvPUwhPpwG75GxIDT7a/ports_columns_correct.png)
