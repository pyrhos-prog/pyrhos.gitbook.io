...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto. La entrada incluye SECURE\_FILE\_PRIV, 3 y 4](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/18r2jbLzIGqYhkXXxRLC/secure_file_priv.jpg)
...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla vacía con columnas: Código de puerto, Ciudad del puerto y Volumen del puerto](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/tpj5jyUTvatIwfoOxKyU/write_proof.png)
...
![Visualización de texto: '¡1 archivo escrito correctamente! 3 4'](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/1MbIshyGMGVUct13u8Gu/write_proof_text.png)
...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla vacía con columnas: Código de puerto, Ciudad del puerto y Volumen del puerto](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/7SZFB32OpbVtgx2PFoig/write_shell.png)
...
![Visualización de texto: uid=33(www-data) gid=33(www-data) groups=33(www-data)](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/2bU1TMArJMTnwmgW5XfH/write_shell_exec_1.png)
