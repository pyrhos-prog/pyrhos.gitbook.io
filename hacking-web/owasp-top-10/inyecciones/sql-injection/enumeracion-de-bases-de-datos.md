...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto. La entrada incluye 10.3.22-MariaDB-1ubuntu1, 3 y 4](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/3rAVJqB0tkGauCe7Ecik/db_version_1.jpg)
...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto. Las entradas incluyen information\_schema, ilfreight, dev, performance\_schema, mysql, todas con Port City 3 y Port Volume 4](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/DxQOtdDYoxw7Iysu7EAs/ports_dbs.png)
...
![Interfaz de búsqueda con un cuadro de texto y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto. La entrada incluye ilfreight, 2 y 3](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/I7dgnw32ACsvTHT65Nzl/db_name.jpg)
...
![Interfaz de búsqueda con un cuadro de texto que contiene 'cn' UNION select 1,table\_n' y un botón denominado 'Buscar'. A continuación se muestra una tabla con columnas: Código del puerto, Ciudad del puerto y Volumen del puerto. Las entradas incluyen nombre de usuario, contraseña, todo con credenciales de Port City y desarrollo de Port Volume](https://content.gitbook.com/content/6EVQrWLD8melKOyrWHcr/blobs/tAkdzR1ENuDR3Jl4OaOt/ports_columns_1.jpg)
