...
* [Ataques](hacking-active-directory/ataques/README.md)
  * [Obtención de credenciales](hacking-active-directory/ataques/obtencion-de-credenciales/README.md)
    * [Extracción Local: SAM, SYSTEM, LSASS.](hacking-active-directory/ataques/obtencion-de-credenciales/extraccion-local-sam-system-lsass..md)
    * [Extracción Local: Atacando LSASS](hacking-active-directory/ataques/obtencion-de-credenciales/extraccion-local-atacando-lsass.md)
    * [Extracción Local: Búsqueda de Credenciales en Windows](hacking-active-directory/ataques/obtencion-de-credenciales/extraccion-local-busqueda-de-credenciales-en-windows.md)
    * [Extracción Local: Credential Manager de Windows](hacking-active-directory/ataques/obtencion-de-credenciales/extraccion-local-credential-manager-de-windows.md)
    * [Ataque kerberos: Kerberoasting](hacking-active-directory/ataques/obtencion-de-credenciales/ataque-kerberos-kerberoasting.md)
    * [Ataque kerberos: AS-REP Roasting](hacking-active-directory/ataques/obtencion-de-credenciales/ataque-kerberos-as-rep-roasting.md)
    * [Bruteforce: Active Directory y NTDS.dit](hacking-active-directory/ataques/obtencion-de-credenciales/bruteforce-active-directory-y-ntds.dit.md)
    * [Bruteforce: Password Spraying, Stuffing y Credenciales por Defecto](hacking-de-infraestructura-y-red/ataques-de-contrasenas/ataques-remotos/password-spraying-stuffing-y-credenciales-por-defecto.md)
    * [Cheatsheet](hacking-active-directory/ataques/obtencion-de-credenciales/cheatsheet.md)
  * [Movimiento Lateral](hacking-active-directory/ataques/movimiento-lateral/README.md)
    * [Pass-the-Hash (PtH)](hacking-active-directory/ataques/movimiento-lateral/pass-the-hash-pth.md)
    * [Pass-the-Ticket (PtT) desde Windows](hacking-active-directory/ataques/movimiento-lateral/pass-the-ticket-ptt-desde-windows.md)
    * [Pass-the-Ticket (PtT) desde Linux](hacking-active-directory/ataques/movimiento-lateral/pass-the-ticket-ptt-desde-linux.md)
    * [Pass-the-Certificate](hacking-active-directory/ataques/movimiento-lateral/pass-the-certificate.md)
