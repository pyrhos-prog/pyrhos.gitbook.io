...
* [Ataques](hacking-active-directory/ataques/README.md)
  * [Ataques de Autenticación](hacking-active-directory/ataques/ataques-de-autenticacion/README.md)
    * [Ataque a SAM, SYSTEM y SECURITY](hacking-active-directory/ataques/ataques-de-autenticacion/ataque-a-sam-system-y-security.md)
    * [Atacando LSASS](hacking-active-directory/ataques/ataques-de-autenticacion/atacando-lsass.md)
    * [Credential Manager de Windows](hacking-active-directory/ataques/ataques-de-autenticacion/credential-manager-de-windows.md)
    * [Active Directory y NTDS.dit](hacking-active-directory/ataques/ataques-de-autenticacion/active-directory-y-ntds.dit.md)
    * [Búsqueda de Credenciales en Windows](hacking-active-directory/ataques/ataques-de-autenticacion/busqueda-de-credenciales-en-windows.md)
    * [Cheatsheet](hacking-active-directory/ataques/ataques-de-autenticacion/cheatsheet.md)
